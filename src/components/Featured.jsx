        ...
        <div className='polkadot relative w-full border-white/50 border-t-2'>
          <div className='w-full h-screen flex justify-center items-center gap-20 py-20' >
            <div className='relative h-full w-11/12 bg-baseblack-100 overflow-y-scroll border-white/50 border flex justify-start items-center flex-col'>
              <a href="https://kashimantram.in" className='font-bold text-6xl text-center font-b tracking-tighter bg-baseblack-100 text-white py-6'>kashimantram<span className='text-basered-200'>.</span>in</a>
          ...
          <div className='w-full h-screen flex justify-center items-center gap-20 py-20' >
            <div className='relative h-full w-11/12 bg-baseblack-100 overflow-y-scroll border-white/50 border flex justify-start items-center flex-col'>
              <a href="https://www.behance.net/gallery/202415959/Tranquility" className='font-bold text-6xl text-center font-b tracking-tighter bg-baseblack-100 text-white py-6'>Tranquility</a>
          ...
          <div className='w-full h-screen flex justify-center items-center gap-20 py-20' >
            <div className='relative h-full w-11/12 bg-baseblack-100 overflow-y-scroll border-white/50 border flex justify-start items-center flex-col'>
              <a href="https://www.behance.net/gallery/202415959/Tranquility" className='font-bold text-6xl text-center font-b tracking-tighter bg-baseblack-100 text-white py-6'>Beyond Border CRM</a>
