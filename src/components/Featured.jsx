...
const Featured = () => {
  return (
    <div className='w-full flex justify-center items-center border-white border-t-2 border-b-2 py-16'>
        <div className='relative'>
            <p className='text-7xl font-bold tracking-tight text-white'>Featured Works</p>
